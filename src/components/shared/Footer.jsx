    ...
    <footer className="relative flex flex-col md:flex-row w-full bg-[#396593] text-white overflow-hidden min-h-[200px]">
      ...
      <div className="bg-[#f0fbfb] w-full md:w-[350px] flex flex-col items-center justify-center py-8 px-6 relative z-10">
        ...
        <div className="flex justify-center space-x-4 w-full">
          {/* Facebook */}
          <div className="w-8 h-8 bg-[#1877F2] rounded-full text-white flex items-center justify-center font-bold text-lg shadow-sm cursor-pointer hover:opacity-90">f</div>
          {/* Instagram */}
          <div className="w-8 h-8 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-500 rounded-lg text-white flex items-center justify-center shadow-sm cursor-pointer hover:opacity-90">
          ...
          {/* TikTok */}
          <div className="w-8 h-8 bg-black rounded-full text-white flex items-center justify-center shadow-sm cursor-pointer hover:opacity-90">
          ...
          <div className="w-8 h-8 bg-[#0a66c2] rounded-md text-white flex items-center justify-center font-bold text-sm shadow-sm cursor-pointer hover:opacity-90">in</div>
        </div>
      </div>
      ...
      <button 
        ...
        className="md:absolute right-0 top-0 bottom-0 w-full md:w-[320px] lg:w-[450px] bg-[#a6c152] md:rounded-l-[250px] flex items-center justify-center shadow-[-10px_0_20px_rgba(0,0,0,0.15)] z-20 cursor-pointer hover:bg-[#9cb64c] transition-all duration-300 group focus:outline-none focus:ring-4 focus:ring-red-500"
      >
