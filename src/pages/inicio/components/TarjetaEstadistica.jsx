...
export default function TarjetaEstadistica({ valor, etiqueta, icono }) {
  return (
    <div className="bg-white rounded-2xl p-8 shadow-xs border border-gray-100 flex flex-col items-center text-center transition-transform hover:-translate-y-1 duration-300">
