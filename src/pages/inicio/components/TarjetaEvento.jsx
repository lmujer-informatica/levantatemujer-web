...
export default function TarjetaEvento({ titulo, fecha, hora, lugar, imagenUrl }) {
  return (
    <article className="flex flex-col sm:flex-row bg-white rounded-2xl overflow-hidden shadow-xs hover:shadow-md transition-shadow border border-gray-100 group">
